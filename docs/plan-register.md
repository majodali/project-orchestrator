...
- P1-N001 [broken-down] Orchestrator v1 — plan: plans/orchestrator-v1.md
  ...
  - P1-N008 [specified] [gated: plan+specify scope boundary, owner review] mtool checker extension-point proposal — spec: specs/p1-n008-mtool-checker-extension-point.md
