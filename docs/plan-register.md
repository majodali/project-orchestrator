...
- P1-N001 [broken-down] Orchestrator v1 — plan: plans/orchestrator-v1.md
  ...
  - P1-N014 [planned] [gated: owner review of the nine plan decisions] Role contracts adopt the v1.4.0 conduct rules — plan: plans/p1-n014-role-contracts-adopt-v140-rules.md
