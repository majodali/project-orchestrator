...
- P1-N001 [broken-down] Orchestrator v1 — plan: plans/orchestrator-v1.md
  ...
  - P1-N015 [specified] Methodology amendments for delegated, multi-agent work — plan: plans/p1-n015-methodology-amendments-delegated-work.md · spec: specs/p1-n015-methodology-amendments-delegated-work.md
